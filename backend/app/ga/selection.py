...
def roulette_wheel_selection(population: list[Chromosome], num_parents: int) -> list[Chromosome]:
    if not population:
        return []
...
def tournament_selection(population: list[Chromosome], num_parents: int, k: int = 3) -> list[Chromosome]:
    if not population:
        return []
...
def elimination_selection(population: list[Chromosome], num_parents: int) -> list[Chromosome]:
    if not population:
        return []
